...
class HomePageWindow(QWidget):
    ...
    def add_feature_buttons(self, layout):
        ...
        features = [
            ("    Inventory\n  Management", "images/inventorymanagement.png", "inventory", "InventoryWindow"),
            ("    Receipe\n  Generator", "images/receipegenerator.png", "receipe", "RecipeGeneratorWindow"),
            (" Shopping List\n    Manager", "images/shoppinglistgenerator.png", "shopping", "ShoppingListWindow"),
            ("   Budget\n   Tracker", "images/budgettracker.png", "budget", "BudgetTrackerWindow"),
            ("     Nutrient\n   Companion", "images/nutritionaltracker.png", "nutrition", "NutritionWindow"),
            ("   Ingredient\n   Substitute", "images/swap.png", "substitution", "SubstitutionWindow")
        ]
