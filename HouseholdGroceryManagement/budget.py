...
class BudgetTrackerWindow(QWidget):
    def __init__(self, user_email):
        super().__init__()
        self.setWindowIcon(QIcon(r"images/budgettracker.png"))
     ...
     # Budget input layout
       ...
       # self.budget_input.setStyleSheet("font-size: 14px; padding: 5px;")
   ...
   """)
        ...
        # Status label for budget difference
        ...
        # Graph
        self.figure_canvas = FigureCanvas(plt.Figure(figsize=(10, 10)))
        ...
        # Back button
        # Bottom layout for back button (styled like in substitution.py)
        bottom_layout = QHBoxLayout()
        bottom_layout.setContentsMargins(0, 20, 0, 20)  # Top, Right, Bottom, Left margins

        self.back_button = QPushButton()
        self.back_button.setIcon(QIcon(r"images/arrow.png"))
...
if __name__ == "__main__":
    ...
    tracker = BudgetTrackerWindow("testuser@example.com")
